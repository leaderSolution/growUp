...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/images/868e956')) {
            // _assetic_868e956
            if ($pathinfo === '/images/868e956.jpg') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '868e956',  'pos' => NULL,  '_format' => 'jpg',  '_route' => '_assetic_868e956',);
            }

            // _assetic_868e956_0
            if ($pathinfo === '/images/868e956_default_profile_1.jpg') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '868e956',  'pos' => 0,  '_format' => 'jpg',  '_route' => '_assetic_868e956_0',);
            }
        ...
        if (preg_match('#^/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'edit_idea')), array (  '_controller' => 'GrowupFrontendBundle\\Controller\\IdeaController::editAction',));
        }
