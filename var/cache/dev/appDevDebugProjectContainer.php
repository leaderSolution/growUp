...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.form.error.messages' => 'getApp_Form_Error_MessagesService',
            'app.form.registration' => 'getApp_Form_RegistrationService',
            'app.images_uploader' => 'getApp_ImagesUploaderService',
    ...
    /**
     * Gets the 'app.form.error.messages' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \GrowupFrontendBundle\FormErrorMessages\FormErrorMessages A GrowupFrontendBundle\FormErrorMessages\FormErrorMessages instance
     */
    protected function getApp_Form_Error_MessagesService()
    {
        return $this->services['app.form.error.messages'] = new \GrowupFrontendBundle\FormErrorMessages\FormErrorMessages();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \GrowupFrontendBundle\Form\RegistrationType A GrowupFrontendBundle\Form\RegistrationType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \GrowupFrontendBundle\Form\RegistrationType();
    }

    /**
     * Gets the 'app.images_uploader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \GrowupFrontendBundle\Services\FileUploader A GrowupFrontendBundle\Services\FileUploader instance
     */
    protected function getApp_ImagesUploaderService()
    {
        return $this->services['app.images_uploader'] = new \GrowupFrontendBundle\Services\FileUploader();
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GrowupFrontendBundle', ($this->targetDirs[3].'\\app/Resources/GrowupFrontendBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GrowupFrontendBundle', ($this->targetDirs[3].'\\src\\GrowupFrontendBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'growup', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\GrowupFrontendBundle\\Entity'))), 'GrowupFrontendBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('GrowupFrontendBundle' => 'GrowupFrontendBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3d443e6b3e55736267d7536478526bc1bfcc44c865b2a2ef00afa14e60c6df50');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('GrowupFrontendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('GrowupFrontendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'GrowupFrontendBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('GrowupFrontendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('GrowupFrontendBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'GrowupFrontendBundle\\Entity\\User');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AppBundle', 8 => 'GrowupFrontendBundle', 9 => 'AsseticBundle', 10 => 'FOSUserBundle', 11 => 'IvoryCKEditorBundle', 12 => 'DebugBundle', 13 => 'WebProfilerBundle', 14 => 'SensioDistributionBundle', 15 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GrowupFrontendBundle/Resources/views'), 'GrowupFrontend');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('48044c9ca718c16d0f29e7ffde99719ddf04dfc4');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_CANDIDATE' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GrowupFrontendBundle' => 'GrowupFrontendBundle\\GrowupFrontendBundle',
            ...
            'secret' => '48044c9ca718c16d0f29e7ffde99719ddf04dfc4',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '48044c9ca718c16d0f29e7ffde99719ddf04dfc4',
            ...
            'fos_user.model.user.class' => 'GrowupFrontendBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'GrowupFrontendBundle\\Form\\RegistrationType',
